...
fileDirCb = ['fileDir = get(findobj(''parent'', gcbf, ''tag'', ''fileDir''), ''String'');' ...
             'fileDirName = uigetdir(fileDir, ''file directory''); drawnow;' ...
             'if fileDirName(1) ~= 0,' ...
...
geometry = {[1, 2,0.75],[1, 2,0.75],1,...
            [1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],...
            [1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],...
            [1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],[1.35,1,1.75,1],...
            [1.35,1,1.75,1],1,[1.35,1,1.75,1],[1.35,1,1.75,1]};
geomvert = [];
uilist = { ...  
    ...
    { 'Style', 'text', 'string', 'Finding heartbeats', ...
      'horizontalalignment', 'right'}, ...
    { 'Style', 'text', 'string', '', 'horizontalalignment', 'right'}, ...
    { 'Style', 'text', 'string', 'Calculating RR measures', ...
      'horizontalalignment', 'right'}, ...
