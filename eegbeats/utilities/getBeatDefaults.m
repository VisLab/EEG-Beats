...
% along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    defaults = struct( ...
        ...
        'Maximum number of milliseconds between peaks for valid IBIs.'), ...
        'ibiMinMs', ...
        getRules(500, {'numeric'}, {'positive', 'scalar'}, ...
        'Minimum number of milliseconds between peaks for valid IBIs.'), ...
        'threshold', ...
        ...
        'doIBIStats', ...
         getRules(true, {'logical'}, {}, ...
        'If true, calculate IBI measures.'), ...
        'ibiBlockMins', ...
         getRules(5, {'numeric'}, {'positive', 'scalar'}, ...
        'Block size in minutes for computing IBI indicators.'), ...
        'ibiBlockStepMins', ...
         getRules(2.5, {'numeric'}, {'positive', 'scalar'}, ...
        'Minutes to slide window for computing IBI indicators.'), ...
        'tpFreqCutoff', ...
         getRules(0.4, {'numeric'}, {'positive', 'scalar'}, ...
        'Upper frequency bound in Hz for computing total power in IBI spectrum.'), ...
         'VLFreqCutoff', ...
         getRules(0.04, {'numeric'}, {'positive', 'scalar'}, ...
        'Upper frequency bound in Hz for computing VLF (very low frequency) power in IBI spectrum.'), ...
         'lowFreqRange', ...
         getRules([0.04, 0.15], {'numeric'}, {'positive', 'row', 'size', [1, 2]}, ...
        'Range in Hz for computing LF (low frequency) power in IBI spectrum.'), ...
        'highFreqRange', ...
         getRules([0.15, 0.4], {'numeric'}, {'positive', 'row', 'size', [1, 2]}, ...
        'Range in Hz for computing HF (high frequency) power in IBI spectrum.') ...
     );
end
