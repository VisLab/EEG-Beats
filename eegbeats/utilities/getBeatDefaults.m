...
% along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    defaults = struct( ...
        ...
        'If true flips the signal regardless of the consensus algorithm.'), ...
        'consensusIntervals', ...
        ...
        'If infinity, plots are clipped at figureClip*iqr outside iqr.'), ...
        'figureVisibility', ...
        getRules('on', {'char'}, {}, ...
        ...
        'removeOutOfRangePeaks', ...
         getRules(true, {'logical'}, {}, ...
        ['If true, exclude peaks marked as too high or too low in RR ' ...
         'measure calculation.']), ...
        'rrBlockMinutes', ...
        ...
        'removeOutOfRangeRRs', ...
         getRules(true, {'logical'}, {}, ...
        ['If true remove RRs that are too small or too large prior ' ...
        'to computing the measures.']), ...
         'spectrumType', ...
         getRules('lomb', {'char'}, {}, ...
